...
int32_t I_MenuUp(void)
{
    return
        ...
        || (CONTROL_GetGameControllerDigitalAxisNeg(GAMECONTROLLER_AXIS_LEFTY) && JOYSTICK_GetAxis(GAMECONTROLLER_AXIS_LEFTY) <= -32767)
        ;
}
...
int32_t I_MenuDown(void)
{
    return
        ...
        || (CONTROL_GetGameControllerDigitalAxisPos(GAMECONTROLLER_AXIS_LEFTY) && JOYSTICK_GetAxis(GAMECONTROLLER_AXIS_LEFTY) >= 32767)
        ;
}
...
int32_t I_MenuLeft(void)
{
    return
        ...
        || (CONTROL_GetGameControllerDigitalAxisNeg(GAMECONTROLLER_AXIS_LEFTX) && JOYSTICK_GetAxis(GAMECONTROLLER_AXIS_LEFTX) <= -32767)
        ;
}
...
int32_t I_MenuRight(void)
{
    return
        ...
        || (CONTROL_GetGameControllerDigitalAxisPos(GAMECONTROLLER_AXIS_LEFTX) && JOYSTICK_GetAxis(GAMECONTROLLER_AXIS_LEFTX) >= 32767)
        ;
}
