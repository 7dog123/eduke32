...
int32_t registerosdcommands(void)
{
    ...
    static osdcvardata_t cvars_game[] =
    {
        ...
        {
            "in_joystickviewleveling", "automatically levels the player's view vertically according to the slope and height of the terrain",
            (void *)&ud.config.JoystickViewLeveling, CVAR_BOOL, 0, 1
        },
